...
CP_Sound bg, bg2, foot, wood1, wood2, wood3, bongo, electric2, hurt2, drop1, ocean,grunt;
...
void SDM_Init(void) {
	...
	bongo = CP_Sound_Load("Assets/Sounds/bongo.ogg");
	electric2 = CP_Sound_Load("Assets/Sounds/Electric2.ogg");
	wood1 = CP_Sound_Load("Assets/Sounds/wood1.ogg");
	ocean = CP_Sound_LoadMusic("Assets/Sounds/ocean1.ogg");
	grunt = CP_Sound_LoadMusic("Assets/Sounds/grunt1.ogg");
}
...
void SDM_PlayBgMusic(int name) {
	...
	switch (name) {
	case 1:
		CP_Sound_PlayAdvanced(bg , 0.4f, 1.0f, TRUE, CP_SOUND_GROUP_MUSIC);
		break;
	case 2:
		CP_Sound_PlayAdvanced(bg2, 0.4f, 1.0f, TRUE, CP_SOUND_GROUP_MUSIC);
		break;
	case 3:
		CP_Sound_PlayAdvanced(ocean, 0.2f, 1.0f, TRUE, CP_SOUND_GROUP_MUSIC);
		break;
	}
}
...
void SDM_PlaySFX(int name) {
	...
	case 1:
		...
		break;
	case 2:
		CP_Sound_PlayAdvanced(grunt, 0.5f, 1.0f, FALSE, CP_SOUND_GROUP_SFX);
		break;
	case 3:
		CP_Sound_PlayAdvanced(wood1, 0.5f, 1.0f, FALSE, CP_SOUND_GROUP_SFX);
		break;
	case 4:
		CP_Sound_PlayAdvanced(bongo, 0.2f, 1.5f, FALSE, CP_SOUND_GROUP_SFX);
		break;
	case 5:
		CP_Sound_PlayAdvanced(electric2, 0.5f, 1.0f, FALSE, CP_SOUND_GROUP_SFX);
		break;
